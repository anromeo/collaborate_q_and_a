  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested question" do
        ...
        Question.any_instance.should_receive(:update_attributes).with({ "question" => "" })
        put :update, {:id => question.to_param, :question => { "question" => "" }}, valid_session
      end
